...
int main(void) {
	...
	{
		printf("\nLa cantidad de personas con estado viudo de más de 60 años es %d", contadorViudosMasSesenta);
	}
	else
	{
		printf("\nNo hay personas mayores de 60 años que sean viudas");
	}
	if(contadorMujerJoven==1)
	{
		printf("\nEl número de cliente de la mujer soltera más joven es %d y tiene %d años", numeroClienteMujerMasJoven, edadMujerMasJoven);
	}
	else
	{
